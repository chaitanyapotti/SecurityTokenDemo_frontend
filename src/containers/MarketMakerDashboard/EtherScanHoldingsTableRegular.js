...
class EtherScanHoldingsTableRegular extends Component {
  state = {
            ...
            <Table>
              ...
              <TableBody>
                {imbalanceSellTradeData.map((item, index) => (
                  ...
                  <TableRow key={index}>
                    <TableCell className="txt-s table-text-pad">
                      <TextField label="Enter Sell Price" value={item.rate} onChange={e => this.updateImbalanceSellArray(e, index, "rate")} />
                    </TableCell>
                    <TableCell className="txt-s table-text-pad">
                      <TextField label="Enter Sell Percent" value={item.percent} onChange={e => this.updateImbalanceSellArray(e, index, "percent")} />
                    </TableCell>
                  </TableRow>
                ))}
              </TableBody>
...
EtherScanHoldingsTableRegular.propTypes = {
